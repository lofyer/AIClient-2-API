...
const translations = {
    'zh-CN': {
        ...
        'oauth.kiro.awsBatchImport': '批量导入 AWS 凭据',
        'oauth.kiro.awsBatchImportDesc': '批量导入多个 AWS 凭据，支持上传包含多个凭据对象的 JSON 文件。',
        'oauth.kiro.awsBatchImportInstructions': '请上传包含多个 AWS 凭据的 JSON 文件（数组格式），或直接粘贴 JSON 内容。每个凭据需包含 clientId、clientSecret、accessToken、refreshToken 四个字段。',
        'oauth.kiro.awsBatchModeFile': '文件上传',
        'oauth.kiro.awsBatchModeJson': 'JSON 粘贴',
        'oauth.kiro.awsBatchUploadFile': '上传凭据文件',
        'oauth.kiro.awsBatchDragDrop': '拖拽 JSON 文件到此处',
        'oauth.kiro.awsBatchClickUpload': '或点击选择文件',
        'oauth.kiro.awsBatchFileHint': '支持包含多个凭据对象的 JSON 数组文件',
        'oauth.kiro.awsBatchJsonInput': 'JSON 内容',
        'oauth.kiro.awsBatchJsonPlaceholder': '粘贴包含多个凭据的 JSON 数组\n例如:\n[\n  {\n    "clientId": "xxx",\n    "clientSecret": "yyy",\n    "accessToken": "zzz",\n    "refreshToken": "aaa"\n  },\n  {...}\n]',
        'oauth.kiro.awsBatchJsonHint': '支持数组格式或单个对象格式',
        'oauth.kiro.awsBatchJsonExample': '查看 JSON 格式示例',
        'oauth.kiro.credentials': '个凭据',
        'oauth.kiro.noCredentials': '没有可导入的凭据',
        'oauth.kiro.duplicateCredential': '凭据已存在（跳过）',
        ...
        'modal.provider.batchImport': '批量导入',
    ...
    'en-US': {
        ...
        'oauth.kiro.awsBatchImport': 'Batch Import AWS Credentials',
        'oauth.kiro.awsBatchImportDesc': 'Batch import multiple AWS credentials. Supports uploading JSON files containing multiple credential objects.',
        'oauth.kiro.awsBatchImportInstructions': 'Upload a JSON file containing multiple AWS credentials (array format), or paste JSON content directly. Each credential must contain clientId, clientSecret, accessToken, and refreshToken.',
        'oauth.kiro.awsBatchModeFile': 'File Upload',
        'oauth.kiro.awsBatchModeJson': 'Paste JSON',
        'oauth.kiro.awsBatchUploadFile': 'Upload Credential File',
        'oauth.kiro.awsBatchDragDrop': 'Drag and drop JSON file here',
        'oauth.kiro.awsBatchClickUpload': 'or click to select file',
        'oauth.kiro.awsBatchFileHint': 'Supports JSON array files containing multiple credential objects',
        'oauth.kiro.awsBatchJsonInput': 'JSON Content',
        'oauth.kiro.awsBatchJsonPlaceholder': 'Paste JSON array containing multiple credentials\nExample:\n[\n  {\n    "clientId": "xxx",\n    "clientSecret": "yyy",\n    "accessToken": "zzz",\n    "refreshToken": "aaa"\n  },\n  {...}\n]',
        'oauth.kiro.awsBatchJsonHint': 'Supports array format or single object format',
        'oauth.kiro.awsBatchJsonExample': 'View JSON Format Example',
        'oauth.kiro.credentials': 'credential(s)',
        'oauth.kiro.noCredentials': 'No credentials to import',
        'oauth.kiro.duplicateCredential': 'Credential already exists (skipped)',
        ...
        'oauth.kiro.importCompleted': 'Completed',
